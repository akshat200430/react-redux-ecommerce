    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-100 px-4">
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          <label className="flex-1 text-center px-4 py-2 rounded-xl border border-slate-300 cursor-pointer bg-slate-100 text-slate-700 has-[:checked]:bg-blue-600 has-[:checked]:text-white transition">
            <input
              type="radio"
              value="user"
              {...register("role", { required: true })}
