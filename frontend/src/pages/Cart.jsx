...
const Cart = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-100 px-4 sm:px-6 lg:px-20 py-10">
      <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-slate-800 mb-8">
        My Cart
      </h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          {mergedCart.map((item) => (
            ...
            >
              {/* IMAGE */}
              <div className="w-24 h-24 sm:w-32 sm:h-32 rounded-xl overflow-hidden bg-slate-200 flex-shrink-0">
                <img
                  src={item.image}
                  alt={item.title}
                  className="w-full h-full object-cover"
              ...
              {/* DETAILS */}
              <div className="flex-1 space-y-2">
                <h2 className="text-sm sm:text-lg font-semibold text-slate-800 line-clamp-1">
                  {item.title}
                </h2>
        ...
        {/* PRICE SUMMARY */}
        {mergedCart.length > 0 && (
          <div className="bg-slate-50 border border-slate-200 p-6 rounded-2xl h-fit">
            ...
            <div className="space-y-3 text-sm text-slate-600">
              ...
              <div className="flex justify-between text-slate-800 font-semibold text-lg">
                <span>Total</span>
                <span>₹{subtotal}</span>
              </div>
            </div>
